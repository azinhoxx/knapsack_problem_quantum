...
data_items_cnt = randint(6000, 6001)
data_memory = [randint(1, 100) for _ in range(data_items_cnt)]
data_weights = [randint(1, 100) for _ in range(data_items_cnt)]
data_cores = [randint(1, 20) for _ in range(data_items_cnt)]
