...
for _ in range(10):
    data_items_cnt = randint(1e2, int(1e2 * 2))
    data_values = [randint(1, int(1e3)) for _ in range(data_items_cnt)]
    data_weights = [randint(1, int(1e3)) for _ in range(data_items_cnt)]
